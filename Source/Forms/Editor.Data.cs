...
namespace CharacterEditor.Forms
{
	public partial class Editor
	{
		private void SyncCharacterDataToGui()
		{
            ...
            labelCurrentLocation.Text = character.PositionX + ", " + character.PositionY + ", " + character.PositionZ;
		...
		private void SyncGuiToCharacterData()
		{
            ...
            string coords = textBoxNewLocation.Text;
            long xCoord = Convert.ToInt64(coords.Substring(0, coords.IndexOf(",")-1));
            coords = coords.Substring(coords.IndexOf(",") + 1, coords.Length - coords.IndexOf(",") - 1);
            long yCoord = Convert.ToInt64(coords.Substring(0, coords.IndexOf(",") - 1));
            long zCoord = Convert.ToInt64(coords.Substring(coords.IndexOf(",") + 1, coords.Length - coords.IndexOf(",") - 1));

            character.PositionX = xCoord;
            character.PositionY = yCoord;
            character.PositionZ = zCoord;
